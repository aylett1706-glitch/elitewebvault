...
const functions = {
  invoke: async (name, payload = {}) => {
    try {
      ...
      console.error('supabaseApi.functions.invoke error', err)
...
const auth = {
  me: async () => {
    try {
      ...
      console.error('supabaseApi.auth.me error', err)
      return null
    }
  }
}
...
export const supabaseApi = { functions, entities, auth, integrations }
export const base44 = supabaseApi
